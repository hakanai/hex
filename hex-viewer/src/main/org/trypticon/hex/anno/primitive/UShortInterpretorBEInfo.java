...
/**
 * Info for {@link org.trypticon.hex.anno.primitive.UShortInterpretorBE}.
 *
 * @author trejkaz
 */
public class UShortInterpretorBEInfo implements InterpretorInfo {
    ...
    public Interpretor create(Map<String, Object> options) {
        return new UShortInterpretorBE();
    }
}