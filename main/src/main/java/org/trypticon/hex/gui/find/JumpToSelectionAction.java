...
/**
 * Action to jump to the selection.
 *
 * @author trejkaz
 */
public class JumpToSelectionAction extends NotebookPaneAction {
    public JumpToSelectionAction() {
        Resources.localiseAction(this, "JumpToSelection");
    }
    ...
    protected void doAction(ActionEvent event, NotebookPane notebookPane) throws Exception {
        ...
        viewer.scrollPosToVisible(viewer.getSelectionModel().getCursor());
    }
}
