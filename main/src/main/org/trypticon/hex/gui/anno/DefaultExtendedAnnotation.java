 ...
 * @author trejkaz
 */
public class DefaultExtendedAnnotation extends SimpleMutableAnnotation implements ExtendedAnnotation {
    private ParametricStyle customStyle;

    public DefaultExtendedAnnotation(long position, long length, Interpreter interpreter, String note) {
