 ...
 * @author trejkaz
 */
public class ConstantDoubleInfo extends AbstractClassFileStructure {
    protected ConstantDoubleInfo() {
    ...
    public Annotation drop(Binary binary, long position) {
        ...
        // Actually documented as two separate u4 in the class file docs.
        Annotation bytes = f8(pos, "bytes"); pos += 8;
