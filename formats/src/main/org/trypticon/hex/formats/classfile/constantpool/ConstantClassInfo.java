 ...
 * @author trejkaz
 */
public class ConstantClassInfo extends AbstractClassFileStructure {
    ...
    public Annotation drop(Binary binary, long position) {
        ...
        return new SimpleMutableGroupAnnotation(position, length, getName(), Arrays.asList(tag, nameIndex));
    }
}
